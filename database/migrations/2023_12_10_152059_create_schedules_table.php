...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('schedules', function (Blueprint $table) {
            ...
            $table->string('kode_absensi', 255)->default('default_value');
            $table->string('tahun_akademik', 255)->default('default_value');
            $table->string('semester', 255)->default('default_value');
